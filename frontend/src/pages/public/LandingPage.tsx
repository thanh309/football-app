...
const LandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen">
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-primary-600 via-primary-600 to-primary-700 text-white">
                <div className="absolute inset-0 bg-black/20"></div>
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
                    <div className="text-center">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                            <span className="block">Kick-off</span>
                            <span className="block text-primary-200">Amateur Football Platform</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            {isAuthenticated ? (
                                ...
                                <>
                                    <Link
                                        to="/register"
                                        className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-primary-700 bg-white hover:bg-primary-50 transition-colors shadow-lg"
                                    >
                                        Get Started
                                    </Link>
                                    <Link
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">Find Fields</h3>
                            <p className="text-slate-600">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">Match Scheduling</h3>
                            <p className="text-slate-600">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">Player Profiles</h3>
                            <p className="text-slate-600">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">Field Owners</h3>
                            <p className="text-slate-600">
