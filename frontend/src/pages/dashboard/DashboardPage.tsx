    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-1">Here's what's happening with your football activities.</p>
            </div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-emerald-600">{stats.upcomingMatches}</p>
                        </div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-teal-600">{stats.myTeams}</p>
                        </div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-blue-600">{stats.notifications}</p>
                        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-gray-700">Find Fields</span>
                    </Link>
                    <Link
                        to="/community"
                        className="flex flex-col items-center p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors"
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                        ...
                        <div>
                            <p className="font-medium text-gray-900">New match scheduled</p>
                            <p className="text-sm text-gray-500">FC Thunder vs. City United - Tomorrow at 7:00 PM</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">John Doe joined FC Thunder</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                        ...
                        <div>
                            <p className="font-medium text-gray-900">Community update</p>
                            <p className="text-sm text-gray-500">Your post received 5 new reactions</p>
                        </div>
                    </div>
                </div>
            </div>
